const Page4 = () => {
    ...
    //       <h2 className="text-xl font-semibold text-blue-700">For Learners</h2>
    //       <h1 className="text-3xl font-bold text-gray-800 mt-2">Achieve Your Goals With Trusted Experts</h1>
    //       <h1 className="text-3xl font-bold text-gray-800 mt-2">and Tailored learning Experience</h1>
    ...
    //       </div>
    //       <div className="flex  space-y-4 justify-start md:col-span-2">
